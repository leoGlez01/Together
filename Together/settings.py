...
SECRET_KEY = 'django-insecure-51nlq-xhm6fmq4=-q!pbrc(vu-23ilcu(w!v_zwmgfv6#8@l)r'
...
MIDDLEWARE = [
    ...
    'chat.middleware.WebSocketCSRFMiddleware',
...
ASGI_APPLICATION = 'Together.asgi.application'
